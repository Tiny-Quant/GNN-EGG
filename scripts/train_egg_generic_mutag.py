...
if __name__ == '__main__':
    ...
    PATH_TO_OBS_DATA = "data/explainees/MUTAG/MUTAG_train_data_list.pkl"
    ...
    if target_class == 0: 
        ...
        PATH_TO_CLASS_EMBEDDINGS = (
            "data/explainees/MUTAG/MUTAG_train_avg_embedding_dict_0.pkl"
        )
    elif target_class == 1:
        target = torch.tensor([0., 1.])
        PATH_TO_CLASS_EMBEDDINGS = (
            "data/explainees/MUTAG/MUTAG_train_avg_embedding_dict_1.pkl"
        )
    ...
    DIS_NODE_FEATS = (7, ) # Tuple(cats, )
    CONT_EDGE_FEATS = None # Int.
    DIS_EDGE_FEATS = (4, ) # Tuple(cats, )
    ...
    class SpecificTrainer(EggGenericTrainer): 
        ...
        def egg_to_ex(self, generated: dict):
            """
            """
            return mutag_helper.egg_to_ex(generated)

        def ex_to_egg(self, obs_batch) -> List[torch.tensor]:
            """
            """
            return mutag_helper.ex_to_egg(obs_batch)
